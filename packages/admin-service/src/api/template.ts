...
export default {
  // 基础模板
  base: {
    options: getBaseTemplateOptions,
    list: getBaseTemplateList,
    getInfo: getBaseTemplateInfo,
    create: createBaseTemplate,
    update: updateBaseTemplate,
    delete: deleteBaseTemplate,
    batchDelete: batchDeleteBaseTemplates,
  },
  // 自定义模板
  custom: {
    options: getCustomTemplateOptions,
    list: getCustomTemplateList,
    getInfo: getCustomTemplateInfo,
    create: createCustomTemplate,
    update: updateCustomTemplate,
    delete: deleteCustomTemplate,
    batchDelete: batchDeleteCustomTemplates,
  },
  // 通用
  copy: copyTemplate,
};
