...
export function AntButton({
  ...
  // 幽灵按钮样式
  const ghostStyles = ghost ? 'bg-transparent border-white text-white hover:bg-white/10' : '';
...
export function AntButtonGroup({ children, className, style }: AntButtonGroupProps) {
  return (
    <div
