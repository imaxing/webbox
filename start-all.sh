...
# 检查 MongoDB 是否运行
echo -e "${YELLOW}[1/6] 检查 MongoDB 状态...${NC}"
...
# 启动 API 服务
echo -e "${YELLOW}[4/6] 启动 API 服务 (端口 3002)...${NC}"
...
# 启动渲染服务
echo -e "${YELLOW}[5/6] 启动渲染服务 (端口 3001)...${NC}"
...
# 启动 Admin 服务
echo -e "${YELLOW}[6/6] 启动 Admin 服务 (端口 3003)...${NC}"
